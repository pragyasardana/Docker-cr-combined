// /docker/vendor/src/github.com/opencontainers/runc/libcontainer/criurpc/criurpc.pb.go    //peter 
...
type CriuOpts struct {
	...
	ManageCgroupsMode *uint32             `protobuf:"varint,34,opt,name=manage_cgroups_mode" json:"manage_cgroups_mode,omitempty"`
        // PreDump           *bool           `protobuf:"varint,35,opt,name=predump" json:"predump,omitempty"` //peter for_criu only
	XXX_unrecognized  []byte              `json:"-"`
}
